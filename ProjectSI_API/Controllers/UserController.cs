...
namespace ProjectSI_API.Controllers
{
    ...
    public class UserController : ApiController
    {
        ...
        public async Task<IHttpActionResult> UpdateisDuplicatePersonalId(UserModels model)
        {
            ...
            var nowUser = _db.Users.Where(p => p.userID == model.userID).FirstOrDefault();
        ...
        public async Task<IHttpActionResult> search(DAL.User model)
        {
            ...
            var user = from u in _db.Users
                       join aspUser in _db.AspNetUsers on u.userID equals aspUser.Id join TitleName in _db.TitleNames on u.titleNameID equals TitleName.titleNameID
        ...
        public async Task<IHttpActionResult> titleName(DAL.TitleName model)
        {
            ...
            var title = from t in _db.TitleNames
                         select
            new
            {
